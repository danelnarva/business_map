    ...
    <div className="grid grid-cols-1 lg:grid-cols-[1fr_350px] gap-6 mt-2">
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-[300px]">
          <div className="bg-slate-800 border border-slate-700 rounded-2xl shadow-xl p-5 flex flex-col">
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="bg-slate-800 border border-slate-700 rounded-2xl p-5 shadow-xl flex flex-col gap-5">
          <div>
            <label className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-2 block">Segmentación por Sexo</label>
          ...
          <div>
            <label className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-2 block">Año de Análisis</label>
            <select 
              value={anioActivo}
              onChange={(e) => setAnioActivo(e.target.value)}
              className="w-full p-2.5 bg-slate-900/50 border border-slate-700 rounded-lg text-white font-medium outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition cursor-pointer"
            >
